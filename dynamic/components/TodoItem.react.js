...
var TodoItem = React.createClass({
  ...
  render: function () {
    ...
    return (
      <li className={ _classes } key={ todo.id }>
        <div className="view">
          <input
            className="toggle"
            type="checkbox"
  ...
  _onToggleComplete: function () { TodoActions.toggleComplete(this.props.todo); },
  _onDoubleClick:    function () { this.setState({ isEditing: true }); },
